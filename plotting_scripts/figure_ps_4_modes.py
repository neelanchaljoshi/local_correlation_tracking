...
ax[0, 0].axvspan(-88 - 10, -88 + 10, color='gray', alpha=0.3)
ax[0, 0].set_title('m=1')
ax[0, 0].set_xlim([-200, 0])
ax[0, 0].set_ylim([0, 5.5])
ax[0, 0].legend(loc='upper right')
ax[0, 0].set_ylabel('LCTMag\n' + r'Power [m$^2/$s$^2$/nHz]')
ax[0, 0].grid()
...
ax[0, 1].axvspan(-73 - 20, -73 + 20, color='gray', alpha=0.3)
ax[0, 1].set_title('m=2')
...
ax[0, 2].axvspan(-110 - 20, -110 + 20, color='gray', alpha=0.3)
ax[0, 2].set_title('m=8')
...
ax[0, 3].axvspan(-213 - 20, -213 + 20, color='gray', alpha=0.3)
ax[0, 3].set_title('m=13')
ax[0, 3].set_xlim([-300, -100])
ax[0, 3].set_ylim([0, 0.06])
ax[0, 3].legend()
ax[0, 3].grid()
...
ax[1, 1].axvspan(-73 - 20, -73 + 20, color='gray', alpha=0.3)
...
ax[1, 2].axvspan(-110 - 20, -110 + 20, color='gray', alpha=0.3)
...
ax[1, 3].axvspan(-213 - 20, -213 + 20, color='gray', alpha=0.3)
