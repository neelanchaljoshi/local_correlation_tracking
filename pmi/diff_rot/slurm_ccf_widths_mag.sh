...
#SBATCH --job-name=2018_12_2018_12_360_120_ccf_widths_5deg_mag_4k
#SBATCH --ntasks=100
...
srun --mpi=pmix python -W ignore main_test_ccf_widths_mag.py $yr_start $month_start $yr_end $month_end $dspan $dstep $downsample $interpolate -l debug
