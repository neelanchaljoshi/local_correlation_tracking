...
#SBATCH --job-name=2018_01_2018_01_120_030_diff_rot_5deg_mag_4k
#SBATCH --ntasks=500
...
srun --mpi=pmix python -W ignore main_psf_interp_mag.py $yr_start $yr_end $dspan $dstep $downsample $interpolate -l debug
