...
if downsample == 1:
	...
	outfile_fmt = '/data/seismo/joshin/pipeline-test/local_correlation_tracking/pmi/diff_rot/data/%d_dspan_{}_dstep_{}_dt_{}_diff_rot_5deg_gran_2k.hdf5'.format(args.dspan, args.dstep, cadence_interp)
	segname = 'continuum.fits'
else:
	infile_fmt = '/scratch/seismo/joshin/pipeline-test/IterativeLCT/hmi.ic_45s/keys_new_swan/keys-%Y.fits'
	outfile_fmt = '/data/seismo/joshin/pipeline-test/local_correlation_tracking/pmi/diff_rot/data/%d_dspan_{}_dstep_{}_dt_{}_diff_rot_5deg_gran_4k.hdf5'.format(args.dspan, args.dstep, cadence_interp)
	segname = 'continuum.fits'
...
# === config: main ===
clatarr = np.arange(-70, 71, 2.5)
clngarr = np.arange(-70, 71, 2.5)
