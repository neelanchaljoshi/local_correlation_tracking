...
#SBATCH --job-name=2018_12_2018_12_360_030_ccf_widths_5deg_gran_4k
#SBATCH --ntasks=50
...
srun --mpi=pmix python -W ignore main_test_ccf_widths_gran.py $yr_start $month_start $yr_end $month_end $dspan $dstep $downsample $interpolate -l debug
