...
#SBATCH --job-name=2018_360_030_diff_rot_5deg_gran_4k_test
...
env time python -W ignore ilct_single_thread.py $dstart $dstop $dspan $dstep $downsample $interpolate -l debug
