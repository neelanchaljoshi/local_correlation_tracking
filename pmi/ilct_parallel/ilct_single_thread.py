...
outfile = f'/data/seismo/joshin/pipeline-test/local_correlation_tracking/pmi/ilct_parallel/data/{args.start}_nt_{nt}_dspan_{args.dspan}_dstep_{args.dstep}_dt_{cadence_interp}_diff_rot_5deg_gran_{resolution}.hdf5'
